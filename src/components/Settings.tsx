                  ...
                  <div className="mb-5.5 gap-5.5 flex flex-col sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="border-stroke bg-gray pl-11.5 pr-4.5 dark:border-strokedark dark:bg-meta-4 w-full rounded border py-3 text-black focus:border-primary focus-visible:outline-none dark:text-white dark:focus:border-primary"
                          type="text"
                          name="fullName"
                          id="fullName"
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        className="border-stroke bg-gray px-4.5 dark:border-strokedark dark:bg-meta-4 w-full rounded border py-3 text-black focus:border-primary focus-visible:outline-none dark:text-white dark:focus:border-primary"
                        type="text"
                        name="phoneNumber"
                        id="phoneNumber"
            ...
            <div className="border-stroke dark:border-strokedark dark:bg-boxdark rounded-sm border bg-white shadow-default">
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div
                    id="FileUpload"
                    className="mb-5.5 bg-gray dark:bg-meta-4 sm:py-7.5 relative block w-full cursor-pointer appearance-none rounded border border-dashed border-primary px-4 py-4"
                  >
                    <input
                      type="file"
                      accept="image/*"
