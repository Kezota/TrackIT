          ...
          <div className="border-stroke dark:border-strokedark w-full xl:w-1/2 xl:border-l-2">
            <div className="sm:p-12.5 xl:p-17.5 w-full p-4">
              ...
              <form>
                ...
                <button className="border-stroke bg-gray dark:border-strokedark dark:bg-meta-4 flex w-full items-center justify-center gap-3.5 rounded-lg border p-4 hover:bg-opacity-50 dark:hover:bg-opacity-50">
                  <span>
                    <svg
                      width="20"
                      height="20"
